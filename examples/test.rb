...
puts ''
if fs.dir.binary.content.start_with?("\x89PNG")
  puts "Yep, dir/binary is an #{fs.dir.binary.mime} (should say image/png)"
else
  puts "Nope, dir/binary isn't an #{fs.dir.binary.mime} (should say image/png)"
end
